    ...
    <div className="p-8 space-y-8">
      <div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <span className="text-sm text-gray-600">Normal - Unchecked</span>
          </div>
      ...
      <div>
        ...
        <div className="flex flex-col gap-4">
          <div className="text-sm text-gray-600"><p>Disabled checkbox</p></div>
          ...
          <div className="text-sm text-gray-600"><p>Enabled checkbox</p></div>
